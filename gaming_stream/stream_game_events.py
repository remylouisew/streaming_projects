...
'''
USAGE:
python ./stream_game_events.py --project_id twitter-stream-rw --bq_dataset_id game_stream --bq_table_id game_stream --pubsub_topic game-logs --sink pubsub --number_of_records 10 --delay 2
'''
